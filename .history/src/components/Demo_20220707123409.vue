...
export default {
  ...
  setup(){
     ...
     const Info=reactive({
      ...
      //     }
      //   })          
      //    dataA=CryptoJS.decrypt(resultA.data)
      //   sessionStorage.setItem("dataA",dataA)
      //   dataA=JSON.parse(dataA)
      //     }else{
      //       console.log(JSON.parse(sessionStorage.getItem("dataA")))
      //       dataA=JSON.parse(sessionStorage.getItem("dataA"))
      //     }
      // }
      ...
      //     }
      //   }) 
      //   dataB=CryptoJS.decrypt(resultB.data)
      //   sessionStorage.setItem("dataB",dataB) 
      //   dataB=JSON.parse(dataB)
      //     }else{
      //     console.log(JSON.parse(sessionStorage.getItem("dataB")))
      //       dataB=JSON.parse(sessionStorage.getItem("dataB"))
      //     }
